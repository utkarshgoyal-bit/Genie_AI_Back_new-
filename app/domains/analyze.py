...
async def handle_analyze(
    ...
    if diagnosis.get("success") is False:
     print("⚠️ YOLO returned zero detections, returning graceful response")

     return {
        "mode": "authenticated",
        "success": False,
        "error": diagnosis.get("error"),
        "message": "No plant detected. Please upload a clearer plant image.",
        "timing": {
