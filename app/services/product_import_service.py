                ...
                for _, row in df.iterrows():
                    ...
                    if pd.isna(scientific_name) and pd.notna(common_name):
                        ...
                        if match_result:
                            ...
                            if score < 95:
                                ProductImportService._log_unmapped_plant({
                                    "product_name": row.get('product_name'),
                                    "input_common_name": common_name,
                                    "matched_scientific_name": scientific_name,
                                    "score": score,
                    ...
                    if pd.notna(scientific_name):
                        products_to_insert.append({
                            ...
                            "disease_common_name": row.get('disease_common_name'),
                            "disease_scientific_name": row.get('disease_scientific_name')
                        })
